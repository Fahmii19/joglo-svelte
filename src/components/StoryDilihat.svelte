...
>
  <div class="w-16 h-16 p-[0.15rem] bg-gray-300 rounded-full">
    <img
      class="w-full h-full p-[0.15rem] bg-white rounded-full object-cover hover:-rotate-6 transform transition"
