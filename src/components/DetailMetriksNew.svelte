  ...
  >
    <form class="formEditListingg RemoveClassformEditListingg">
      <div class="grid grid-cols-2 gap-y-1 gap-x-3 mb-4">
        ...
        <!-- b -->
        <div class="h-full grid grid-cols-2 gap-x-4 gap-y-4">
          <div class="relative w-full">
            <label class="block text-xs font-bold -mb-1" for="koordinat_new51">
              Konektivitas Pejalan Kaki
            </label>

            <div
              class="w-full h-[2rem] flex items-center bg-gray-200 rounded-lg flex px-3 mt-1.5"
            >
              <label
          ...
          <!-- Ruang Terbuka  -->
          <div class="relative w-full">
            <label class="block text-xs font-bold -mb-1" for="koordinat_new52">
              Ruang Terbuka
            </label>
            <div
              class="w-full h-[2rem] flex items-center bg-gray-200 rounded-lg flex px-3 mt-1.5"
          ...
          <!-- Ruang Terbuka  -->
          <div class="relative w-full">
            <label class="block text-xs font-bold -mb-1" for="koordinat_new53">
              Fasilitas Komunitas
            </label>
          ...
          <!-- Ruang Terbuka  -->
          <div class="relative w-full">
            <label class="block text-xs font-bold -mb-1" for="koordinat_new54">
              Budaya Perkotaan
            </label>
            <div
              class="w-full h-[2rem] flex items-center bg-gray-200 rounded-lg flex px-3 mt-1.5"
          ...
          <!-- Ruang Terbuka  -->
          <div class="relative w-full">
            <label class="block text-xs font-bold -mb-1" for="koordinat_new55">
              Ruang Usaha
            </label>
            <div
              class="w-full h-[2rem] flex items-center bg-gray-200 rounded-lg flex px-3 mt-1.5"
          ...
          <!-- Ruang Terbuka  -->
          <div class="relative w-full">
            <label class="block text-xs font-bold -mb-1" for="koordinat_new56">
              Pelayanan Kesehatan
            </label>
            <div
              class="w-full h-[2rem] flex items-center bg-gray-200 rounded-lg flex px-3 mt-1.5"
          ...
          <!-- Ruang Terbuka  -->
          <div class="relative w-full">
            <label class="block text-xs font-bold -mb-1" for="koordinat_new57">
